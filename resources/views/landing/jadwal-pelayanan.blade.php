            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-12 mt-5" data-aos="fade-up" data-aos-delay="200">
                    <div class="content">
                        ...
                        <p class="text-muted mb-4">Jadwal pelayanan dikelompokkan berdasarkan jenis ibadah untuk bulan
                            {{ $bulanIni }}.</p>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="heading{{ $index }}">
                                            <button class="accordion-button {{ $index == 0 ? "" : "collapsed" }}"
                                                ...
                                                {{ $jenis->jenis_ibadah }}
                                                <span class="badge bg-primary ms-2">{{ $jenis->jadwalIbadah->count() }}
                                                    Jadwal</span>
                                            </button>
                                        </h2>
                                        <div id="collapse{{ $index }}"
                                            ...
                                            data-bs-parent="#jenisIbadahAccordion">
                                            <div class="accordion-body">
                                                            ...
                                                            <div class="col-md-6 col-lg-4 mb-3">
                                                                <div class="card border-left-primary h-100">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <p class="card-text mb-2">
                                                                            <i
                                                                                class="fas fa-map-marker-alt me-2 text-muted"></i>
                                                                        ...
                                                                        @if ($jadwal->alamat)
                                                                            <p class="card-text">
                                                                                <small class="text-muted">
                                                                                    <i
                                                                                        class="fas fa-location-arrow me-1"></i>
                                                ...
                                                @else
                                                    <div class="alert alert-light" role="alert">
                                                        ...
                                                        Belum ada jadwal untuk jenis ibadah
                                                        <strong>{{ $jenis->jenis_ibadah }}</strong> di bulan ini.
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
