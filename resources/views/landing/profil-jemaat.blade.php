...
<main class="main">
    ...
    <section id="hero" class="hero section">
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h3 class="card-title text-center text-uppercase fw-bold">Ubah Profil Jemaat</h3>
                    <form method="POST" action="{{ route('profil.update') }}">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama</label>
                            <input type="text" class="form-control" id="name" name="name" value="{{ $jemaat->name }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control" id="email" name="email" value="{{ $jemaat->email }}" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="no_telp" name="no_telp" value="{{ $jemaat->no_telp }}">
                        </div>
