...
<head>
    ...
    <title>Ucapan Syukur - GPI Sidang Perawang</title>
    <meta name="description" content="Ucapan Syukur">
    <meta name="keywords" content="warta gereja, informasi gereja, gpi perawang, ucapan syukur">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="warta-detail" data-aos="fade-up">
                            ...
                            <div class="warta-header">
                                <p>BRI 3358-01-076482-53-9</p>
                                <p>Atas nama: Sarlen Gultom</p>
                            </div>
                            @if ($errors->any())
                            ...
                            <div class="warta-content">
                                <div class="content-text">
                                    <form action="{{ route("ucapan-syukur.submit.post") }}" method="POST"
                                        ...
                                        <div class="row mb-3">
                                            <label for="bukti_transfer" class="col-sm-2 col-form-label">Bukti
                                                Transfer</label>
                                            <div class="col-sm-10">
                                        ...
                                        <button type="submit" class="btn btn-primary rounded float-end w-25">
