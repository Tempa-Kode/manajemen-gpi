                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                                    ...
                                    @foreach ($pendaftaranExisting as $pendaftaran)
                                        <div class="jadwal-item">
                                            <div class="row align-items-center g-2 flex-wrap">
                                                ...
                                                <div class="col-6 col-md-2">
                                                    <span
                                                        class="badge rounded-pill text-bg-{{ $pendaftaran->status == "menunggu" ? "warning" : ($pendaftaran->status == "konfirmasi" ? "success" : "danger") }}">
                                                ...
                                                <div class="col-12 col-md-1 text-end">
                                                    @php
                                                        $tanggalIbadah = \Carbon\Carbon::parse(
                                                            $pendaftaran->jadwalIbadah->tanggal,
                                                        );
                                                        $jamIbadah = \Carbon\Carbon::parse(
                                                            $pendaftaran->jadwalIbadah->jam,
                                                        );
                                                        $waktuIbadah = $tanggalIbadah->setTimeFromTimeString(
                                                            $jamIbadah->format("H:i:s"),
                                                        );
                                                        $batasWaktu = $waktuIbadah->copy()->subHours(24);
                                                        $masihBisaDibatalkan =
                                                            \Carbon\Carbon::now()->lessThan($batasWaktu) ||
                                                            $pendaftaran->status == "menunggu";
                                                    @endphp

                                                    @if ($masihBisaDibatalkan)
                                                        <form
                                                            action="{{ route("pendaftaranIbadah.cancel", $pendaftaran->id) }}"
                                                            method="POST"
                                                            ...
                                                            <button type="submit"
                                                                ...
                                                                title="Batalkan Pendaftaran (Batas: {{ $batasWaktu->translatedFormat("d M Y, H:i") }})"
                                                ...
                                                <div class="col-12">
                                                    <small class="text-muted">
                                                        @if ($masihBisaDibatalkan)
                                                            ...
                                                            <span class="text-warning">Dapat dibatalkan sampai:
                                                                {{ $batasWaktu->translatedFormat("d F Y, H:i") }}
                                                                WIB</span>
                                                        @else
                                                            <i class="fas fa-lock text-danger me-1"></i>
                                                            <span class="text-danger">Batas pembatalan telah terlewati
                                                                (H-1)</span>
                                                        @endif
                                                    </small>
                                                </div>
                        ...
                        <div class="form-container" id="form-pendaftaran" data-aos="fade-up">
                            ...
                            @else
                                <p class="text-center text-muted mb-4">
                                    Selamat datang <strong>{{ Auth::user()->name }}</strong>! Silakan lengkapi formulir di
                                    bawah ini untuk mendaftar ibadah.
                                </p>
                            @endguest
                            ...
                            @auth
                                @if ($jadwalIbadah->count() > 0)
                                    <div class="jadwal-info">
                                        <h5 class="mb-3"><i class="fas fa-calendar-alt me-2"></i>Jadwal Ibadah Tersedia
                                        </h5>
                                ...
                                <form action="{{ route("pendaftaranIbadah.store") }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select select2-jadwal" id="jadwal_ibadah_id"
                                            name="jadwal_ibadah_id" required>
                                            <option value="">Pilih Jadwal Ibadah</option>
                                            @foreach ($jadwalIbadah as $jadwal)
                                                <option value="{{ $jadwal->id }}"
                                                    {{ old("jadwal_ibadah_id") == $jadwal->id ? "selected" : "" }}
                    ...
                    <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
                        <div class="alert alert-info">
                            ...
                            <ul class="mb-0">
                                ...
                                <li><strong>Pembatalan pendaftaran dapat dilakukan maksimal 1 hari sebelum
                                        ibadah</strong></li>
        ...
        $(document).ready(function() {
            ...
            $('.select2-jadwal').select2({
                ...
                templateResult: function(option) {
                    ...
                    var $option = $('<div class="select2-option-wrapper"><div class="option-text">' +
                        text + '</div></div>');
                    return $option;
                }
            });
