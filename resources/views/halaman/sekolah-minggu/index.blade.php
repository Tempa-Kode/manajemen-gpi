...
@section('title', 'Data Sekolah Minggu')

@section('halaman', 'Data Sekolah Minggu')
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Manajemen data anak-anak sekolah minggu</p>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="{{ route('sekolah-minggu.create') }}" class="btn btn-primary">
                ...
                <div class="card-body p-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="d-flex gap-1">
                                                    <a href="{{ route('sekolah-minggu.show', $item->id) }}"
                                                       class="btn btn-sm btn-outline-info" title="Detail">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="{{ route('sekolah-minggu.edit', $item->id) }}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form method="POST" action="{{ route('sekolah-minggu.destroy', $item->id) }}" class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
                    ...
                    @else
                        <div class="text-center py-5">
                            <div class="mb-3">
                                <i class="fas fa-child text-muted" style="font-size: 4rem;"></i>
                            </div>
                            <h5 class="text-muted">Belum ada data anak sekolah minggu</h5>
                            <p class="text-muted">Silakan tambahkan data anak sekolah minggu pertama</p>
                            <a href="{{ route('sekolah-minggu.create') }}" class="btn btn-primary">
