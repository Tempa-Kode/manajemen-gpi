...
@section('halaman', 'Edit Data Remaja')
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('data-jemaat.show', $remaja->jemaat->id) }}" class="btn btn-outline-secondary">
                                <i class="fas fa-arrow-left me-2"></i>Kembali
                            </a>
                            <a href="{{ route('remaja.show', $remaja) }}" class="btn btn-outline-info">
    ...
    <div class="row">
        <div class="col-12 col-lg-8">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('remaja.update', $remaja) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="id_kk" class="form-label text-dark fw-bold">
                                        <i class="fas fa-users text-success me-2"></i>Keluarga
                                    ...
                                    <select class="form-select @error('id_kk') is-invalid @enderror"
                                        ...
                                        @foreach($jemaat as $kel)
                                            <option value="{{ $kel->id }}"
                                                    {{ old('id_kk', $remaja->id_kk) == $kel->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="nama" name="nama"
                                           value="{{ old('nama', $remaja->nama) }}"
                                           placeholder="Masukkan nama remaja" required>
                                    @error('nama')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="d-flex gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input @error('jenis_kelamin') is-invalid @enderror"
                                                   ...
                                                   {{ old('jenis_kelamin', $remaja->jenis_kelamin) == 'L' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="laki">
                                                <i class="fas fa-mars text-success me-1"></i>Laki-laki
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input @error('jenis_kelamin') is-invalid @enderror"
                                                   type="radio" name="jenis_kelamin" id="perempuan" value="P"
                                                   {{ old('jenis_kelamin', $remaja->jenis_kelamin) == 'P' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="perempuan">
                                                <i class="fas fa-venus text-success me-1"></i>Perempuan
                                            </label>
                                        </div>
                                    </div>
                                    @error('jenis_kelamin')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="pendidikan" class="form-label text-dark fw-bold">
                                        <i class="fas fa-graduation-cap text-success me-2"></i>Pendidikan
                                    </label>
                                    <input type="text"
                                           class="form-control @error('pendidikan') is-invalid @enderror"
                                           id="pendidikan" name="pendidikan"
                                           value="{{ old('pendidikan', $remaja->pendidikan) }}"
                                           placeholder="Contoh: SMA Kelas 11, S1 Teknik, dll">
                                    @error('pendidikan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="pekerjaan" class="form-label text-dark fw-bold">
                                        <i class="fas fa-briefcase text-success me-2"></i>Pekerjaan
                                    </label>
                                    <input type="text"
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ route('remaja.show', $remaja) }}" class="btn btn-secondary">
        ...
        <div class="col-12 col-lg-4">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-3">
                    <div class="mb-3">
                        <small class="text-muted">Nama Remaja</small>
                        <div class="fw-bold">{{ $remaja->nama }}</div>
                    </div>
                    <div class="mb-3">
                        <small class="text-muted">Keluarga</small>
                        <div class="fw-bold">{{ $remaja->jemaat->nama_keluarga }}</div>
                    </div>
                    <div class="mb-3">
                        <small class="text-muted">Umur Saat Ini</small>
                        <div class="fw-bold">{{ $remaja->umur }} tahun</div>
                    </div>
                    <div class="mb-3">
                        <small class="text-muted">Data Dibuat</small>
                        <div class="fw-bold">{{ $remaja->created_at->format('d F Y') }}</div>
                    </div>
                    <div>
                        <small class="text-muted">Terakhir Diupdate</small>
                        <div class="fw-bold">{{ $remaja->updated_at->format('d F Y, H:i') }}</div>
                    </div>
                </div>
            </div>
