...
@section('halaman', 'Tambah Data Tamu')
    ...
    <div class="col-12">
        <div class="card mb-4 px-3">
            <div class="card-header pb-0">
                <h4 class="text-center">Tambah Data Tamu</h4>
                @if (session('error'))
            ...
            <div class="card-body px-0 pt-0 pb-2">
                <form action="{{ route('tamu.store') }}" method="POST" class="px-3">
                    @csrf
                    @method('POST')
                    <div class="form-group">
                        <label for="nama" class="form-control-label">Nama</label>
                        <input class="form-control" type="text" name="name" id="nama" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="no_telp" id="no_telp" value="{{ old('no_telp') }}">
                        @error('no_telp')
                            <span class="text-danger fst-italic">{{ $message }}</span>
                        @enderror
                    </div>
