        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'data-jemaat.index' ? 'active' : '' }}" href="{{ route('data-jemaat.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Data Keluarga Jemaat</span>
                </a>
            </li>
            ...
            <li class="nav-item {{ Route::currentRouteName() == 'jadwal-ibadah.index' ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('jadwal-ibadah.index') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item {{ Route::currentRouteName() == 'permohonan-surat.index' ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('permohonan-surat.index') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'saran-masukan.index' ? 'active' : '' }}" href="{{ route('saran-masukan.index') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-chat-round text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Saran & Masukan</span>
                </a>
            </li>
            <li class="nav-item mt-3">
