...
@section('title', 'Tambah Jenis Ibadah - Manajemen GPI')

@section('halaman', 'Tambah Jenis Ibadah')
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        <h6>Form Tambah Jenis Ibadah</h6>
                        <a href="{{ route('jenis-ibadah.index') }}" class="btn btn-secondary btn-sm">
                            <i class="fas fa-arrow-left"></i> Kembali
                        </a>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('jenis-ibadah.store') }}" method="POST">
                            @csrf
